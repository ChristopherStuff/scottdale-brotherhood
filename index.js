...
const update_information = "Новый Support, добавлена команда /set\nЕсли указать значение 0, то передаст жалобу модераторам\nЕсли указать значение 1, то передаст жалобу админам сервера";
let t_mode = 0;
