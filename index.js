...
const update_information = "Тикеты - Изменен порядок обновления. Все записывается сначало в базу данных, после чего уже выполняется скрипт. Синхронизация улучшена.";
let t_mode = 0;
